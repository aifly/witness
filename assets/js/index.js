...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsMusicIndex = __webpack_require__(33);
	...
	var _componentsLibObserable = __webpack_require__(36);
	...
	var _vueJsTap = __webpack_require__(38);
	...
	new _vue2['default']({
		...
		mounted: function mounted() {
			...
			_componentsLibUtil.zmitiUtil.getOauthurl(function () {
				_this2.updatePv();
			});
			_componentsLibUtil.zmitiUtil.wxConfig(document.title, window.desc);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// <template>
	// 	<div ref='page'  class="lt-full zmiti-index-main-ui " :style="{background:'url('+imgs.indexBg+') no-repeat center top',backgroundSize:'cover'}"   :class="{'show':show}" >
	//
	// 		<div class='zmiti-submit-bg'>
	// 			<img :src="imgs.btnBg" alt="" />
	// 			<span>我来见证</span>
	// 		</div>
	// 	</div>
	// </template>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//
	// 			<div class='zmiti-model-list' ref='modellist' :style="{height:viewH+'px'}">
	// 				<ul v-show='index<=-1'>
	// 					<li>
	// 						<div   :class='{"active":i===current}' v-if='i%2===0' v-for='(model,i) in modelList' :key="i">
	// 							<img v-tap='[getDetail,i]' @touchstart='imgStart' :src="model.url" alt="">
	// 							<img  v-tap='[toggleModel,i]'  :src='imgs.checked' class='zmiti-checked'/>
	// 						</div>
	// 					</li>
	// 					<li>
	// 						<div  :class='{"active":i===current}' v-if='i%2===1' v-for='(model,i) in modelList' :key="i">
	// 							<img v-tap='[getDetail,i]' @touchstart='imgStart' :src="model.url" alt="">
	// 							<img v-tap='[toggleModel,i]'   :src='imgs.checked' class='zmiti-checked'/>
	// 						</div>
	// 					</li>
	...
	// 			</div>
	//
	// 			<div class='zmiti-done' v-if='current>-1'>
	// 				<img :src="imgs.btnBg" alt="">
	// 				<span>
	// 					选好了，去拍照~
	// 				</span>
	...
	exports['default'] = {
		...
		methods: {
			...
			toggleModel: function toggleModel(index, e) {
		...
		mounted: function mounted() {
			...
			this.scroll = new _iscroll2['default'](this.$refs['modellist'], {});
